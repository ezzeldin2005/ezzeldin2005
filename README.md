...
- 🌱 Currently expanding into **Angular** and **Docker/DevOps** practices
- 🏊 Competitive swimmer — 2nd place nationally at the 2023 Thanaweya Amma Swimming Championship
...
A full-featured web-based book platform built with **3-Tier Architecture**. Users can browse books by category, read online, download, and maintain a personalized favorites list. Includes a complete admin dashboard with role-based access control (Admin & User roles) and full book/user CRUD management.

**Key patterns:** Repository Pattern · Generic Repository · View Models · Separation of Concerns

---

### ⚽ [Play Local](https://github.com/ezzeldin2005/NXT33_ONL3_SWD5_S5_PlayLocal) — Sports Venue Booking Platform
> `ASP.NET Core MVC` · `C#` · `Entity Framework Core` · `SQL Server` · `Bootstrap`

A sports venue booking and community platform with a **multi-role system** for Players and Venue Owners. Features include venue creation and management, working hours, courts management, and booking flows — all with secure session handling and role-based authorization.

---

### 🥗 [SmartPlate--Nutrition Tracker](https://github.com/ezzeldin2005/SmartPlate) — Macro & Meal Planning App
> `HTML` · `CSS` · `JavaScript` · `Django`

A responsive web app for calculating macros, tracking meals, and generating personalized meal plans, backed by a full Django architecture (models, views, data handling).

---

### 💼 [Jobify--Job Search Platform](https://github.com/ezzeldin2005/Jobify) — College Team Project
> `HTML` · `CSS` · `JavaScript` · `Django`

A collaborative team project — a job search platform for managing listings and applications, with contributions to both the responsive front end and the Django backend.
...
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=ezzeldin2005&layout=compact&hide_border=true&theme=default)
...
I'm open to **software engineering internships, junior full-stack roles, and collaborative open-source projects**. Feel free to reach out!

📧 [ezzeldinomar7@gmail.com](mailto:ezzeldinomar7@gmail.com) · 💼 [LinkedIn](https://linkedin.com/in/ezzeldin-omar-a65302291) · 🐙 [GitHub](https://github.com/ezzeldin2005)

---

<div align="center">
  <sub>Built with ☕ and clean architecture principles</sub>
</div>
